...
const SelectType: FC<OwnProps> = ({ setSurveyMode }) => {
  ...
  return (
    <div className="grid justify-items-center h-[80%]">
      <h3 className="text-3xl dark:text-neutral-300">검사 유형을 선택하세요</h3>
      <div className="grid justify-items-center">
        <button
          className="block text-2xl border my-2 rounded-2xl px-5 min-w-full hover:bg-neutral-100 dark:text-neutral-300 dark:bg-neutral-800 dark:hover:bg-neutral-700"
