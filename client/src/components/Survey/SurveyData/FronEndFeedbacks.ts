...
export const frontEndfeedback: Feedback = {
  "1": {
  ...
  "2": {
    ...
    "4": "훌륭합니다! 웹 접근성에 대한 깊은 이해를 가지고 있습니다. 이제는 웹 접근성 베스트 프랙티스를 다른 개발자에게 가르쳐 보세요.",
  },
  "3": {
    "0": "반응형 디자인에 대한 이해가 필요합니다. 반응형 디자인의 기본 원칙과 구현 방법을 학습하는 것이 좋습니다.",
    "1": "반응형 디자인에 대한 기본적인 이해가 있지만, 더 복잡한 레이아웃을 구현하려면 추가 학습이 필요합니다. CSS 그리드와 플렉스박스에 대해 알아보세요.",
  ...
  "4": {
    ...
    "2": "디자인 시스템이나 UI 라이브러리에 대해 상당히 익숙하다면, 그것은 훌륭합니다! 이런 지식은 웹 개발에서 매우 중요합니다. 계속해서 이런 도구들과 스킬을 확장하려 노력해 보세요.",
  ...
  "5": {
    "0": "프로토타이핑 툴을 사용해보지 않았다면, 확실히 시도해 보세요. Figma, Sketch, Adobe XD 등이 프로토타이핑을 위한 강력한 도구가 될 수 있습니다.",
    "1": "프로토타이핑 도구를 가끔 사용한다면, 이 도구들을 더 자주 사용하여 디자인 프로세스를 향상시키는 방법을 찾아보세요.",
    "2": "프로토타이핑 도구를 종종 사용한다면, 그것은 좋은 습관입니다. 이러한 도구를 활용하면 디자인과 개발 프로세스가 더욱 원활해질 것입니다.",
  ...
  "6": {
    "0": "자바스크립트에 대한 이해가 부족하다면, 기본적인 문법부터 시작해서 차츰 공부해 보는 것이 좋습니다. 웹 개발의 핵심 언어이므로 이해가 필수적입니다.",
    "1": "자바스크립트에 대한 기본적인 이해를 가지고 있다면, 고급 개념을 학습하거나 프로젝트에 적용해보는 것이 좋습니다.",
    "2": "자바스크립트에 대해 상당히 익숙하다면, 그것은 훌륭합니다! 이런 지식은 웹 개발에서 매우 중요합니다. 계속해서 이런 도구들과 스킬을 확장하려 노력해 보세요.",
    "3": "자바스크립트에 대해 매우 익숙하다면, 당신은 이미 웹 개발에서 중요한 경쟁력을 갖추고 있습니다. 다양한 프로젝트에서 이런 도구들을 활용해 보세요.",
    "4": "당신이 자바스크립트에 완벽히 익숙하다면, 당신은 훌륭한 프론트엔드 개발자입니다. 당신의 능력을 최대한 활용하여 더욱 멋진 웹 페이지를 만들어보세요!",
  },
  "7": {
    "0": "ES6와 그 이상의 자바스크립트 특징에 불편함을 느낀다면, 기본적인 특징들부터 차근차근 학습해보는 것이 좋습니다. 이는 코드의 효율성과 가독성을 향상시킬 수 있습니다.",
    "1": "기본적인 ES6 특징에 익숙하다면, 더욱 고급 특징들을 학습하고 사용해보는 것이 좋습니다.",
    "2": "ES6에 대해 상당히 익숙하다면, 그것은 훌륭합니다! 이런 지식은 웹 개발에서 매우 중요합니다. 계속해서 이런 도구들과 스킬을 확장하려 노력해 보세요.",
  ...
  "8": {
    "0": "자바스크립트 프레임워크나 라이브러리에 대해 불편함을 느낀다면, 하나를 선택해서 기본적인 개념부터 차근차근 학습해보는 것이 좋습니다. 이는 개발 시간을 절약하고, 코드의 효율성과 가독성을 향상시킬 수 있습니다.",
    "1": "기본적인 프레임워크나 라이브러리에 익숙하다면, 더욱 고급 기능들을 학습하고 사용해보는 것이 좋습니다.",
    "2": "자바스크립트 프레임워크나 라이브러리에 대해 상당히 익숙하다면, 그것은 훌륭합니다! 이런 지식은 웹 개발에서 매우 중요합니다. 계속해서 이런 도구들과 스킬을 확장하려 노력해 보세요.",
    "3": "자바스크립트 프레임워크나 라이브러리에 대해 매우 익숙하다면, 당신은 이미 웹 개발에서 중요한 경쟁력을 갖추고 있습니다. 다양한 프로젝트에서 이런 도구들을 활용해 보세요.",
    "4": "당신이 자바스크립트 프레임워크나 라이브러리에 완벽히 익숙하다면, 당신은 훌륭한 프론트엔드 개발자입니다. 당신의 능력을 최대한 활용하여 더욱 멋진 웹 페이지를 만들어보세요!",
  },
  "9": {
    ...
    "2": "상태 관리 도구를 상당히 자주 사용한다면, 그것은 훌륭합니다! 이런 도구는 애플리케이션의 복잡성을 관리하고 코드의 가독성을 향상시키는 데 중요한 역할을 합니다.",
  ...
  "10": {
    "0": "비동기 작업을 처리하는 것이 낯설다면, JavaScript의 Promise나 async/await와 같은 개념을 학습하는 것을 추천합니다. 이러한 개념들은 복잡한 비동기 코드를 간결하고 이해하기 쉽게 만드는데 도움이 됩니다.",
    "1": "가끔 비동기 작업을 처리한다면, 그것은 좋은 시작입니다. 하지만 이러한 작업을 자주 처리하게 되면, 당신의 코드는 훨씬 더 효율적이고 이해하기 쉬워질 것입니다.",
  ...
  "11": {
    ...
    "1": "성능 최적화에 대해 가끔 고려한다면, 그것은 좋은 시작입니다. 하지만 성능 최적화를 더 자주 고려하면 웹 애플리케이션의 성능을 획기적으로 개선할 수 있습니다.",
  ...
  "12": {
    "0": "Lighthouse나 성능 감사 도구를 사용하는 데에 익숙하지 않은 것 같습니다. Lighthouse는 웹 애플리케이션의 성능을 평가하고 개선하는 데에 매우 유용한 도구입니다. 성능 감사 도구에 대한 학습과 실습을 통해 개발 프로세스에서 더 나은 성능을 달성할 수 있습니다.",
    "1": "Lighthouse나 성능 감사 도구를 가끔 사용한다면, 그것은 좋은 시작입니다. 이 도구는 웹 애플리케이션의 성능을 평가하고 최적화하는 데에 유용합니다. 더 자주 사용하여 성능 감사 도구에 대한 익숙함을 향상시킬 수 있습니다.",
    "2": "Lighthouse나 성능 감사 도구를 자주 사용한다면, 웹 애플리케이션의 성능 평가와 최적화에 대한 이해를 잘 가지고 있는 것입니다. 이 도구를 활용하여 웹 애플리케이션의 성능을 지속적으로 개선할 수 있습니다.",
    "3": "Lighthouse나 성능 감사 도구를 매우 자주 사용한다면, 웹 애플리케이션의 성능을 개선하기 위한 뛰어난 도구 활용 능력을 갖추고 있는 것입니다. 성능 감사 도구를 통해 실시간으로 성능을 모니터링하고 최적화할 수 있습니다.",
    "4": "Lighthouse나 성능 감사 도구를 항상 사용한다면, 웹 애플리케이션의 성능 최적화에 대한 높은 수준의 이해와 경험을 가지고 있습니다. 이 도구를 통해 웹 애플리케이션의 성능을 최적화하고 사용자 경험을 향상시킬 수 있습니다.",
  },
  "13": {
    "0": "레이지 로딩, 코드 분할 및 캐싱과 같은 기술을 사용하여 성능을 최적화하는 데에 자신감이 부족한 것 같습니다. 이러한 기술은 웹 애플리케이션의 성능을 향상시키는 데에 매우 유용합니다. 추가적인 학습과 실습을 통해 이러한 기술들을 더 잘 이해하고 적용할 수 있을 것입니다.",
    "1": "레이지 로딩, 코드 분할 및 캐싱과 같은 기술을 가끔 사용한다면, 그것은 좋은 시작입니다. 이러한 기술들은 웹 애플리케이션의 성능을 최적화하는 데에 유용합니다. 더 많은 프로젝트에서 이러한 기술들을 적용하여 경험을 향상시킬 수 있습니다.",
    "2": "레이지 로딩, 코드 분할 및 캐싱과 같은 기술을 자주 사용한다면, 성능 최적화에 대한 이해와 경험을 가지고 있는 것입니다. 이러한 기술들을 효과적으로 활용하여 웹 애플리케이션의 성능을 개선할 수 있습니다.",
    "3": "레이지 로딩, 코드 분할 및 캐싱과 같은 기술을 매우 자주 사용한다면, 성능 최적화에 대한 뛰어난 능력을 갖추고 있는 것입니다. 이러한 기술들을 적극적으로 활용하여 웹 애플리케이션의 성능을 최대한으로 향상시킬 수 있습니다.",
    "4": "레이지 로딩, 코드 분할 및 캐싱과 같은 기술을 항상 사용한다면, 성능 최적화에 대한 탁월한 이해와 실력을 가지고 있는 것입니다. 이러한 기술들을 효과적으로 구현하여 웹 애플리케이션의 성능을 최적화하고 사용자 경험을 향상시킬 수 있습니다.",
  },
  "14": {
